...
const Header = ({ token, onLogout }) => {
  ...
  return (
    <div className="flex flex-wrap justify-center items-center space-x-6 py-4 bg-white">
      ...
      <Link
        to="/calendar/"
        className="px-4 py-2 rounded-xl text-xl bg-blue-400 text-white font-bold hover:bg-blue-600"
      >
        Dashboard
      </Link>
      ...
      <form onSubmit={handleSearch} className="flex space-x-2">
        ...
        <button
          type="submit"
          className="px-4 py-2 rounded-xl text-xl bg-green-400 text-white font-bold hover:bg-green-600"
        >
          Search
        </button>
      </form>
